...
param(
    ...
    # Curated allowlist of top-100 C# repos on GitHub (EvanLi/Github-Ranking).
    # Discovery searches each repo directly. When non-empty, global keyword search is disabled.
    # Pass -RepoAllowlist @() to override and fall back to global search (not recommended).
