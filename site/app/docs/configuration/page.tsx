...
const faqSchema = buildFaqSchema([
  {
    ...
    a: "Yes. GauntletCI works out of the box with no configuration file required. All built-in rules are enabled by default (currently 39). Place a .gauntletci.json file at your repository root to customize behavior.",
  },
  {
