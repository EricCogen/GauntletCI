...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/docs/integrations/azure-devops`,      changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/bitbucket`,         changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/github-action`,     changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/gitlab`,            changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/mcp`,               changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/neovim`,            changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/pre-commit`,        changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/rider`,             changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/visual-studio`,     changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/integrations/vscode`,            changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/docs/privacy-modes`,                  changeFrequency: "monthly", priority: 0.7 },
