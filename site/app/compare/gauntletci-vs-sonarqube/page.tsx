          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border bg-card/20">
                <td className="px-5 py-3 text-foreground/80 font-semibold">SonarQube</td>
                <td className="px-5 py-3 text-muted-foreground">Code quality, security vulnerabilities, maintainability</td>
                <td className="px-5 py-3 text-amber-400/80">Behavioral change risk in the diff</td>
              </tr>
