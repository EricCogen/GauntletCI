          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border bg-card/20">
                <td className="px-5 py-3 text-foreground/80 font-semibold">Code Climate</td>
                <td className="px-5 py-3 text-muted-foreground">Maintainability, duplication, test coverage over time</td>
                <td className="px-5 py-3 text-amber-400/80">Behavioral change risk, pre-commit diff-scoped detection</td>
              </tr>
