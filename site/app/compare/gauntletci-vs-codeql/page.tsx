          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border bg-card/20">
                <td className="px-5 py-3 text-foreground/80 font-semibold">CodeQL</td>
                <td className="px-5 py-3 text-muted-foreground">Security vulnerabilities via semantic code analysis, variant analysis</td>
