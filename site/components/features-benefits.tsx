...
const items = [
  ...
  },
  {
    ...
    benefit: "Works in air-gapped environments, on proprietary codebases, and in organizations with strict data residency requirements — with no policy exceptions needed. An unconditional guarantee, not a setting.",
  },
  {
    icon: BrainCircuit,
